...
function buildPolarYamlBlock(filename, polarDomain) {
    ...
    lines.push('# Materials are NOT generated by this template.');
    lines.push('# Use "Detect Colors & Generate YAML Template" to detect dominant RGBs');
    lines.push('# and inject the materials: block. Library presets and Coil groups can');
    lines.push('# be assigned per colour from that modal.');
    if (N) {
    ...
    lines.push(`  theta_range: ${theta_range}`);
